...
public class ToPerformDragAndDropWithClickAndHoldRelease {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		for(WebElement element : elementsToBeDragged) {
			...
			actions.moveToElement(driver.findElement(By.xpath("//div[@class='demo-description']/p[3]"))).perform();
			Thread.sleep(500);
			actions.release(dropLocation).perform();
