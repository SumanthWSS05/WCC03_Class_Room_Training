...
public class UnderstandingAsserts {
	...
	public void addToCart() {
		...
		softAssert.assertEquals(actualWelcomePageTitle, expectedWelcomePageTitle, "Welcome page is not displayed");
		...
		softAssert.assertEquals(usernameData, usernameEntered, "Email id text field did not accept valid email id");
		...
		softAssert.assertEquals(passwordData, passwordEntered, "Password text field did not accept valid password");
